# /gen-manual-tests — Generate Manual Test Cases from User Story
...
To also generate automation artifacts in the same run, use `/e2e` instead.
...
/gen-manual-tests --story user-stories/auth.md --mode 2 --types positive,negative,security

# Preview what would be generated
/gen-manual-tests --story user-stories/checkout.md --dry-run

# Re-evaluate existing scenarios (mode 3)
/gen-manual-tests --project my-project --mode 3
...
💡 Next Steps:
   ...
   - Generate automation: /e2e --story [path] --url [url]
     OR: /generate-automation-tests --story [path] --url [url]
```
