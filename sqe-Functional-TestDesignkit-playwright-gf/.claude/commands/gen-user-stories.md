...
To run the full pipeline (req doc → user stories → manual TCs → automation): use `/e2e --req`.
...
- **For full pipeline** (req → stories → manual TCs → automation), use `/e2e --req` instead
